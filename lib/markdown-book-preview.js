...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'markdown-book-preview:downloadTemplate': () => this.downloadTemplate('https://raw.githubusercontent.com/lwohtsu/atom-markdown-book-preview/master/booksample/'),
  ...
  // テンプレートをダウンロードする
  downloadTemplate(baseurl, hasmnp = false) {
